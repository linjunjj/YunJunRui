...
import com.linjun.yunjunrui.ui.device.adapter.TRMenuAdapter;
...
public class TopRightMenu {
     ...
     * @return
     */
    public TopRightMenu addMenuItem(MenuItems item){
     ...
     * @return
     */
    public TopRightMenu addMenuList(List<MenuItems> list){
