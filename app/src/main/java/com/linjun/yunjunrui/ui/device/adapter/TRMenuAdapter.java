...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    public TRMenuAdapter(Context context, TopRightMenu topRightMenu, List<MenuItems> menuItemList, boolean show) {
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
        final MenuItems menuItem = menuItemList.get(position);
        if (showIcon){
